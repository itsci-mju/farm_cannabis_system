...
public class ListPlantingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<String> adapter = new ArrayAdapter<>(ListPlantingActivity.this,
                    ...
                    public void onComplete(Object response) {
                        ...
                        if(list.length > 0){
                            ...
                            for(int i = 0; i < list.length; i++){
                                ...
                                if(list[i].getStatus().equals(spinner_Status.getSelectedItem().toString())){
                                    ...
                                    if(list[i].getStatus().equals("กำลังเพาะปลูก")){
                                        btnHarvest.setVisibility(View.INVISIBLE);
                                        btnListHarvest.setVisibility(View.INVISIBLE);
                                    }else if(list[i].getStatus().equals("เก็บเกี่ยวหมดแล้ว")){
                                        btnHarvest.setVisibility(View.INVISIBLE);
                                        btnAddPlantingProgress.setVisibility(View.INVISIBLE);
                                    }
