...
public class ListAllOrdersActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] list_status = {"รอการยืนยัน", "ยืนยันแล้ว", "รอการตรวจสอบชำระเงิน", "ชำระเงินแล้ว", "ปฏิเสธ"};

        ArrayAdapter<String> adapter = new ArrayAdapter<>(ListAllOrdersActivity.this,
                    ...
                    public void onComplete(Object response) {
                        ...
                        if (list.length > 0) {
                            ...
                            for (int i = 0; i < list.length; i++) {
                                ...
                                if (list[finalI].getStatus().equals(spinner_Status.getSelectedItem().toString())) {
                                    ...
                                    manager.getPaymentByOrderID(list[finalI].getOrderID(), new WSManager.WSManagerListener() {
                                        ...
                                        public void onComplete(Object response) {
                                            if (response != null) {
                                                ...
                                                TextView paydate = v.findViewById(R.id.paydatetime);
                                                Date dpaydate = new Date(payment.getPaydate());
                                                String spaydate = sdf.format(dpaydate);
                                                Date dpaytime = new Date(payment.getPaytime());
                                                String spaytime = sdf2.format(dpaytime);
